...
// CONFIG2L
#pragma config FOSC = FRCPLL    // Oscillator (Fast RC Oscillator with Postscaler (FRCDIV))
...
#pragma config FSCM = CSECMD    // Clock Switching and Monitor Selection Configuration bits (Clock switching is disabled, fail safe clock monitor is disabled)
