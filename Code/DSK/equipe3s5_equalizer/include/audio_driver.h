...
extern float pitchShifterInputBuffer0[BUFFER_SIZE];
extern float pitchShifterInputBuffer1[BUFFER_SIZE];
extern float pitchShifterOutBuffer0[BUFFER_SIZE];
extern float pitchShifterOutBuffer1[BUFFER_SIZE];
