...
MCBSP_Config MCBSP_SPIConfig = {
        ...
        MCBSP_FMKS(RCR, RWDLEN1, 8BIT)         |   // This changes to 8 bits per message
        ...
        MCBSP_FMKS(SRGR, GSYNC, SYNC)        |   // Free running
...
{
    bool value = MCBSP_rsyncerr(hSpi);
    MCBSP_FSET(SPCR0,RSYNCERR,0);
    return value;
}
