...
% *************************************************************************
%
function [outputVector] = pitchShift_01(inputVector, windowSize, hopSize, step)
...
[y,numberFramesInput] = createFrames_01(x,hop,winSize);
...
%% Processing    
    ...
    mult = hop * 2*pi*(0:(winSize-1))/winSize;
...
outputTimeStretched = fusionFrames_01(outputy,hopOut);
